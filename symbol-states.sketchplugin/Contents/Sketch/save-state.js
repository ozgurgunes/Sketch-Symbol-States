...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  if (selection.length != 1 || selection.layers[0].type != sketch_dom__WEBPACK_IMPORTED_MODULE_0___default.a.Types.SymbolInstance) {
    ...
    var stateName = saveStateDialog("State Name", "Please give a name to symbol state", states.map(function (state) {
      return state.name;
    }));
...
function saveStateDialog(msg, info, items) {
  ...
  var accessory = _ui_js__WEBPACK_IMPORTED_MODULE_2__["createCombobox"](items);
  var response = _ui_js__WEBPACK_IMPORTED_MODULE_2__["createDialog"](msg, info, accessory, buttons);
  var result = accessory.stringValue();

  if (response === 1000) {
    if (!result.length() > 0) {
      Object(_analytics_js__WEBPACK_IMPORTED_MODULE_3__["default"])(context, "error", "name");
